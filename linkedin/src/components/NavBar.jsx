  ...
  return (
    <Navbar expand="lg" id='navbarer' className="d-flex justify-content-center bg-white">
      <Container className="d-flex mx-auto px-2">
        ...
        <Navbar.Brand href="#home"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 34 34" id="global-nav-logo">
          <title>
            LinkedIn
      </title>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          ...
          <Nav className="d-inline-flex ml-auto mt-1">
            ...
            <Nav.Link fluid href="#home" className="flex-col text-center py-0">
              <Link to={'/'}>
                <svg id="global-nav-icon--mercado__home" height="30" width="30" viewBox="0 0 30 30" className="mx-4">
            ...
            <Nav.Link href="#link" className="flex-col text-center py-0">
              <Link to={'/search'}>
                <svg id="global-nav-icon--mercado__my-network" height="30" width="30" viewBox="0 0 30 30" className="mx-4">
            ...
            <Nav.Link href="#home" className="flex-col text-center py-0 text-nowrap">
              <svg id="global-nav-icon--classic__work" height="30" width="30" viewBox="0 0 30 30">
